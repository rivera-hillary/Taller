...
describe('CPD - Contract length', () => {
    ...
    it('selects 60', () => {
        cy.get('#ATAndT-2-card > :nth-child(8) > .pr-0 > .choices > .choices__inner').click().get('.choices__item--selectable').should('be.hidden').invoke('show').contains('60').click({force: true});
        //cy.log();
    });
});